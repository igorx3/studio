...
const mockProducts: ProductLineItem[] = [
    { itemId: 'inv1', name: 'Magnesio Complex 60 caps', sku: 'SKU-MAG001', quantity: 2, declaredValue: 1200 },
    { itemId: 'inv2', name: 'Vitamina D3', sku: 'SKU-VD3002', quantity: 1, declaredValue: 800 },
];
...
export const mockOrders: Order[] = [
  {
    ...
    warehouse: { packingStatus: 'pending', mainLocation: 'Recepción', subLocation: 'P1' },
    isDraft: false,
  ...
  },
  {
    ...
    products: [{ itemId: 'inv3', name: 'Smart TV 55"', sku: 'TV-LG-55', quantity: 1, declaredValue: 15000 }],
    ...
    warehouse: { packingStatus: 'packed', mainLocation: 'Alistamiento', subLocation: 'Q2' },
    isDraft: false,
  ...
  },
  {
    ...
    products: [{ itemId: 'inv4', name: 'Libro "Cien Años de Soledad"', sku: 'LIB-GGM-01', quantity: 1, declaredValue: 850 }],
    ...
    warehouse: { packingStatus: 'dispatched', mainLocation: 'Despacho', subLocation: 'P1' },
    isDraft: false,
